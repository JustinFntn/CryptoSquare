      ...
      <div class="prose max-w-4xl">
        ...
        <section>
          ...
          <ul>
            ...
            <li><strong>Restrictions :</strong> L’accès peut être restreint ou suspendu en cas de violation des
              présentes
              CGU.</li>
          </ul>
        </section>
...
export default {
  data() {
    return {
      updatedAt: '2025-01-28', // Remplacez par une date dynamique si nécessaire
    };
  },
};
</script>
